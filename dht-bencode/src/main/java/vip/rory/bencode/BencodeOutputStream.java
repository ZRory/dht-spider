...
public class BencodeOutputStream extends FilterOutputStream {
    ...
    /**
     * Creates a new BencodeOutputStream that writes to the {@link OutputStream}
     * passed and uses the {@link Charset} passed for encoding the data.
     *
    ...
    /**
     * Creates a new BencodeOutputStream that writes to the {@link OutputStream}
     * passed and uses UTF-8 {@link Charset} for encoding the data.
     *
     * @param out the {@link OutputStream} to write to
     */
     ...
     * <p>
     * The number is converted to a Long, meaning any precision is lost as it
     * not supported by the bencode spec.
     *
     ...
     * <p>
     * Data contained in the List is written as the correct type. Any
     * {@link Iterable} is written as a List, any {@link Number} as a Number,
     * any {@link Map} as a Dictionary and any other {@link Object} is written
     * as a String calling the {@link Object#toString()} method.
     *
     ...
     * <p>
     * Data contained in the Dictionary is written as the correct type. Any
     * {@link Iterable} is written as a List, any {@link Number} as a Number,
     * any {@link Map} as a Dictionary and any other {@link Object} is written
     * as a String calling the {@link Object#toString()} method.
     *
    ...
    private static String encodeObject(final Object o) {
        ...
        if (o instanceof byte[]) {
            return encode(new String((byte[]) o, Charset.forName("ISO-8859-1")));
        }

...
public final class Bencode {
    ...
    /**
     * Creates a new Bencoder using the {@link Charset} passed for
     * encoding/decoding.
     *
     ...
     * @return the {@link Type} or {@link Type#UNKNOWN} if it cannot be
     *         determined
     ...
     * <p>
     * The number is converted to a {@link Long}, meaning any precision is lost
     * as it not supported by the bencode spec.
     *
    ...
    public byte[] encode(final Object o) {
        ...
        return encode(BeanUtils.beanToMapComplate(o), Type.DICTIONARY);
    }
